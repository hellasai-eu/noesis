-- Update user_has_course_tag_access to require BOTH tags AND enrollment for students
...
AS $$
  SELECT 
    ...
    (
      ...
      AND
      -- Check enrollment access (enrolled in class with active offering for this course)
      EXISTS (
        SELECT 1
